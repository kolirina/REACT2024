...
var paginationSlice = createSlice({
  name: "pagination",
  initialState,
  reducers: {
...
var { setPage, setTotalPages } = paginationSlice.actions;
var paginationSlice_default = paginationSlice.reducer;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1722443301859.0938";
}
var initialState2 = {
  items: []
};
...
var { selectItem, unselectItem, unselectAll, toggleItem } = selectedItemsSlice.actions;
