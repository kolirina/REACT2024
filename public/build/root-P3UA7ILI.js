...
var { useSearchAnimalsQuery, useGetAnimalDetailsQuery } = apiSlice;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1723231182139.5063";
}
var initialState2 = {
  isLoading: false
};
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1723230466349.3975";
}
var loadingMiddleware = (storeAPI) => (next) => (action) => {
  if (apiSlice.endpoints.searchAnimals.matchPending(action) || apiSlice.endpoints.getAnimalDetails.matchPending(action)) {
    storeAPI.dispatch(setLoading(true));
  } else if (apiSlice.endpoints.searchAnimals.matchFulfilled(action) || apiSlice.endpoints.getAnimalDetails.matchFulfilled(action) || apiSlice.endpoints.searchAnimals.matchRejected(action) || apiSlice.endpoints.getAnimalDetails.matchRejected(action)) {
    storeAPI.dispatch(setLoading(false));
  }
  return next(action);
};
var loadingMiddleware_default = loadingMiddleware;
...
function App() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("body", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Provider_default, { store, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ThemeProvider, { children: [
